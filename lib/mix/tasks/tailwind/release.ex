defmodule Mix.Tasks.Tailwind.Release do
  ...
  Defaults to Tailwind 4.3.3 with DaisyUI 5.7.36 and release channel v4.3.3-rc1.
  ...
  def run(args) do
    ...
    release_opts =
      [
        version: Keyword.get(opts, :version, "4.3.3"),
        release_channel: Keyword.get(opts, :channel, "v4.3.3-rc1"),
